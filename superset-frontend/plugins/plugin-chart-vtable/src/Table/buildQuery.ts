...
import { VTableFormData } from './types';
 ...
 */
export function getQueryMode(formData: VTableFormData) {
...
const buildQuery: BuildQuery<VTableFormData> = (
  formData: VTableFormData,
  options,
) => {
  const {
...
export const cachedBuildQuery = (): BuildQuery<VTableFormData> => {
